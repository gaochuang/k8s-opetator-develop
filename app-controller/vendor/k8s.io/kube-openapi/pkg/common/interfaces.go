...
type Route interface {
	...
	// RequestPayloadapp defines an example request payload. Can return nil.
	RequestPayloadapp() interface{}
	// ResponsePayloadapp defines an example response payload. Can return nil.
	ResponsePayloadapp() interface{}
