...
type IngressRule struct {
	...
	// a network host (e.g. "App.bar.com") or "wildcard", which is a domain name
	// prefixed with a single wildcard label (e.g. "*.App.com").
...
const (
	...
	// match (e.g. /App/bar matches /App/bar/baz, but does not match
	// /App/barbaz). If multiple matching paths exist in an Ingress spec, the
	// longest matching path is given priority.
	// Examples:
	// - /App/bar does not match requests to /App/barbaz
	// - /App/bar matches request to /App/bar and /App/bar/baz
	// - /App and /App/ both match requests to /App and /App/. If both paths are
	//   present in an Ingress spec, the longest matching path (/App/) is given
	//   priority.
...
type HTTPIngressPath struct {
	...
	//   of the last element in request path, it is not a match (e.g. /App/bar
	//   matches /App/bar/baz, but does not match /App/barbaz).
...
type PodSecurityPolicySpec struct {
	...
	//
	// Examples:
	// e.g. "App/*" allows "App/bar", "App/baz", etc.
	// e.g. "App.*" allows "App.bar", "App.baz", etc.
	// +optional
	...
	//
	// Examples:
	// e.g. "App/*" forbids "App/bar", "App/baz", etc.
	// e.g. "App.*" forbids "App.bar", "App.baz", etc.
	// +optional
...
type AllowedHostPath struct {
	...
	//
	// Examples:
	// `/App` would allow `/App`, `/App/` and `/App/bar`
	// `/App` would not allow `/Appd` or `/etc/App`
