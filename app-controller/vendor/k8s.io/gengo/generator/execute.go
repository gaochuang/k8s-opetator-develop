...
func (c *Context) ExecutePackage(outDir string, p Package) error {
	...
	// package is github.com/App/bar, outDir=., p.Path()=github.com/App/bar/generated,
	// then we really want to be writing files to ./generated, not ./github.com/App/bar/generated.
	// The following will trim a path prefix (github.com/App/bar) from p.Path() to arrive at
