...
type CSIDriverSpecApplyConfiguration struct {
	...
	PodInAppnMount       *bool                            `json:"podInAppnMount,omitempty"`
...
// WithPodInAppnMount sets the PodInAppnMount field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the PodInAppnMount field is set to the value of the last call.
func (b *CSIDriverSpecApplyConfiguration) WithPodInAppnMount(value bool) *CSIDriverSpecApplyConfiguration {
	b.PodInAppnMount = &value
	return b
}
