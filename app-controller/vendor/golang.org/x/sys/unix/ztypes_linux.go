...
type PerfEventAttr struct {
	...
	Ext1               uint64
	Ext2               uint64
	Branch_app_type uint64
	app_regs_user   uint64
	app_stack_user  uint32
	Clockid            int32
	app_regs_intr   uint64
	Aux_watermark      uint32
	app_max_stack   uint16
	_                  uint16
}
...
const (
	...
	PerfBitappIDAll                   = CBitFieldMaskBit18
...
const (
	...
	PERF_app_ADDR                      = 0x8
	PERF_app_READ                      = 0x10
	PERF_app_CALLCHAIN                 = 0x20
	PERF_app_ID                        = 0x40
	PERF_app_CPU                       = 0x80
	PERF_app_PERIOD                    = 0x100
	PERF_app_STREAM_ID                 = 0x200
	PERF_app_RAW                       = 0x400
	PERF_app_BRANCH_STACK              = 0x800
	PERF_app_REGS_USER                 = 0x1000
	PERF_app_STACK_USER                = 0x2000
	PERF_app_WEIGHT                    = 0x4000
	PERF_app_DATA_SRC                  = 0x8000
	PERF_app_IDENTIFIER                = 0x10000
	PERF_app_TRANSACTION               = 0x20000
	PERF_app_REGS_INTR                 = 0x40000
	PERF_app_PHYS_ADDR                 = 0x80000
	PERF_app_AUX                       = 0x100000
	PERF_app_CGROUP                    = 0x200000
	PERF_app_DATA_PAGE_SIZE            = 0x400000
	PERF_app_CODE_PAGE_SIZE            = 0x800000
	PERF_app_WEIGHT_STRUCT             = 0x1000000
	PERF_app_MAX                       = 0x2000000
	PERF_app_BRANCH_USER_SHIFT         = 0x0
	PERF_app_BRANCH_KERNEL_SHIFT       = 0x1
	PERF_app_BRANCH_HV_SHIFT           = 0x2
	PERF_app_BRANCH_ANY_SHIFT          = 0x3
	PERF_app_BRANCH_ANY_CALL_SHIFT     = 0x4
	PERF_app_BRANCH_ANY_RETURN_SHIFT   = 0x5
	PERF_app_BRANCH_IND_CALL_SHIFT     = 0x6
	PERF_app_BRANCH_ABORT_TX_SHIFT     = 0x7
	PERF_app_BRANCH_IN_TX_SHIFT        = 0x8
	PERF_app_BRANCH_NO_TX_SHIFT        = 0x9
	PERF_app_BRANCH_COND_SHIFT         = 0xa
	PERF_app_BRANCH_CALL_STACK_SHIFT   = 0xb
	PERF_app_BRANCH_IND_JUMP_SHIFT     = 0xc
	PERF_app_BRANCH_CALL_SHIFT         = 0xd
	PERF_app_BRANCH_NO_FLAGS_SHIFT     = 0xe
	PERF_app_BRANCH_NO_CYCLES_SHIFT    = 0xf
	PERF_app_BRANCH_TYPE_SAVE_SHIFT    = 0x10
	PERF_app_BRANCH_HW_INDEX_SHIFT     = 0x11
	PERF_app_BRANCH_MAX_SHIFT          = 0x12
	PERF_app_BRANCH_USER               = 0x1
	PERF_app_BRANCH_KERNEL             = 0x2
	PERF_app_BRANCH_HV                 = 0x4
	PERF_app_BRANCH_ANY                = 0x8
	PERF_app_BRANCH_ANY_CALL           = 0x10
	PERF_app_BRANCH_ANY_RETURN         = 0x20
	PERF_app_BRANCH_IND_CALL           = 0x40
	PERF_app_BRANCH_ABORT_TX           = 0x80
	PERF_app_BRANCH_IN_TX              = 0x100
	PERF_app_BRANCH_NO_TX              = 0x200
	PERF_app_BRANCH_COND               = 0x400
	PERF_app_BRANCH_CALL_STACK         = 0x800
	PERF_app_BRANCH_IND_JUMP           = 0x1000
	PERF_app_BRANCH_CALL               = 0x2000
	PERF_app_BRANCH_NO_FLAGS           = 0x4000
	PERF_app_BRANCH_NO_CYCLES          = 0x8000
	PERF_app_BRANCH_TYPE_SAVE          = 0x10000
	PERF_app_BRANCH_HW_INDEX           = 0x20000
	PERF_app_BRANCH_MAX                = 0x40000
	PERF_BR_UNKNOWN                       = 0x0
	PERF_BR_COND                          = 0x1
	PERF_BR_UNCOND                        = 0x2
	PERF_BR_IND                           = 0x3
	...
	PERF_BR_MAX                           = 0xb
	PERF_app_REGS_ABI_NONE             = 0x0
	PERF_app_REGS_ABI_32               = 0x1
	PERF_app_REGS_ABI_64               = 0x2
...
const (
	...
	ETHTOOL_A_COALESCE_RATE_app_INTERVAL   = 0x17
