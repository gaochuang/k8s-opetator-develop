...
// TypeNameHandleFunction declares functions that can handle translating the name of a app object
// into the restful documentation for the service.
type TypeNameHandleFunction func(app interface{}) string
...
// the reflection API.
func reflectTypeName(app interface{}) string {
	return reflect.TypeOf(app).String()
}
