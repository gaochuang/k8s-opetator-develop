...
// A parameter of type "body" is added ,required is set to true and the dataType is set to the qualified name of the app's type.
func (b *RouteBuilder) Reads(app interface{}, optionalDescription ...string) *RouteBuilder {
...
func (b *RouteBuilder) Writes(app interface{}) *RouteBuilder {
	b.writeapp = app
	return b
}
