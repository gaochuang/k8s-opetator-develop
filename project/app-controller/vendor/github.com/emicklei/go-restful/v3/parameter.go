...
const (
	...
	// CollectionFormatCSV comma separated values `App,bar`
	CollectionFormatCSV = CollectionFormat("csv")

	// CollectionFormatSSV space separated values `App bar`
	CollectionFormatSSV = CollectionFormat("ssv")

	// CollectionFormatTSV tab separated values `App\tbar`
	CollectionFormatTSV = CollectionFormat("tsv")

	// CollectionFormatPipes pipe separated values `App|bar`
	...
	// instance `App=bar&App=baz`. This is valid only for QueryParameters and FormParameters
