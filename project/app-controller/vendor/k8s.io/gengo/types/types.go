...
const (
	...
	//   type App string
	//   type Bar App
	// Bar is an alias of App.
	//
	// In the real go type system, App is a "Named" string; but to simplify
	// generation, this type system will just say that App *is* a builtin.
	// We then need "Alias" as a way for us to say that Bar *is* a App.
	Alias Kind = "Alias"
