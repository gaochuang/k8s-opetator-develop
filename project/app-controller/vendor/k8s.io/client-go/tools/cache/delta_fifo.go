...
// DeltaFIAppptions is the configuration parameters for DeltaFIFO. All are
// optional.
type DeltaFIAppptions struct {
...
//
// Use `NewDeltaFIFOWithOptions(DeltaFIAppptions{..., EmitDeltaTypeReplaced: true})`
// instead to receive a `Replaced` event depending on the type.
//
// Deprecated: Equivalent to NewDeltaFIFOWithOptions(DeltaFIAppptions{KeyFunction: keyFunc, KnownObjects: knownObjects})
func NewDeltaFIFO(keyFunc KeyFunc, knownObjects KeyListerGetter) *DeltaFIFO {
	return NewDeltaFIFOWithOptions(DeltaFIAppptions{
		KeyFunction:  keyFunc,
...
func NewDeltaFIFOWithOptions(opts DeltaFIAppptions) *DeltaFIFO {
