...
type Descriptor interface {
	...
	// field "App_field" in message "proto.package.MyMessage" is
	// uniquely identified as "proto.package.MyMessage.App_field".
...
//	}
//	message BarMessage {
//		extends AppMessage { optional BarMessage bar_field = 100; }
//	}
//
// Field "bar_field" is an extension of AppMessage, but its full name is
// "example.BarMessage.bar_field" instead of "example.AppMessage.bar_field".
...
// Thus, a value named "App_VALUE" declared within an enum uniquely identified
// as "proto.package.MyEnum" has a full name of "proto.package.App_VALUE".
