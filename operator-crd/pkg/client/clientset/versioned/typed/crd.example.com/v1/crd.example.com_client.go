...
import (
	"net/http"
	v1 "operator-crd/pkg/apis/crd.example.com/v1"
...
// CrdV1Client is used to interact with features provided by the crd.example.com group.
type CrdV1Client struct {
	restClient rest.Interface
}

func (c *CrdV1Client) Foos(namespace string) FooInterface {
